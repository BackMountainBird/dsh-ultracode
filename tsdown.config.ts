 ...
 *
 * The host half ships as tsc-emitted ESM (build script runs both tsc passes
 * first); this config consumes the emitted lib/client/index.js.
 */
 ...
 * package name — read from package.json so a rename cannot leave the client
 * half registering a stale id.
 */
